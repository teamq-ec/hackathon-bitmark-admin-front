...
export class QuizComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    var playlist = new talkify.playlist()
        ...
        .build();
    playlist.play();*/
    //this.taskpoolService.getFeedBack().subscribe(response => { console.log(response);});
  }
  ...
  getScore() {
    ...
    this.quizzes.forEach((question: any) => {
  ...
  setResponse(value: any) {
    let index = this.quizzes.findIndex((x: any) => x.sourceSentence.text === value.question);
    if(index === -1) {
